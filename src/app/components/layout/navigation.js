"use client";
import { Logo, LogoLight } from "@/app/components/icons/icons";
...
export default function Navigation() {
  ...
  useEffect(() => {
    ...
    console.log("this is dark mode from nav: ", darkMode);
  }, [isMenuOpen, darkMode]);
  ...
  return (
    <nav className=" w-full max-w-[1240px]  mx-auto px-5 flex items-center justify-between  md:px-6 py-3 relative z-50">
      ...
      <div className="flex items-center">
        ...
        <button className="main-button-md" onClick={toggleDarkMode}>
          {" "}
          hey
        </button>
      </div>
      ...
      >
        <div className="flex flex-col px-4 py-2">
          <Link
            href="/"
            className={`text-white py-2 border-b border-gray-800 hover:text-p-500 block transition-all duration-300 transform ${
              isMenuOpen
